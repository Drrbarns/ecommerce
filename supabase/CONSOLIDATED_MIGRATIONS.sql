-- ========================================
-- MOOLRE COMMERCE - CONSOLIDATED DATABASE SCHEMA
-- ========================================
-- This file contains the complete database schema for Moolre Commerce.
-- Copy and paste this ENTIRE file into the Supabase SQL Editor and run it.
-- 
-- Order of execution:
--   1. Base Schema (products, collections, orders)
--   2. Migration 002: Categories and Brands
--   3. Migration 003: Product Variants and Images
--   4. Migration 004: Customers and Auth
--   5. Migration 005: Server-side Carts
--   6. Migration 006: Shipping Zones and Rates
--   7. Migration 007: Coupons and Discounts
--   8. Migration 008: Payment Processing
--   9. Migration 009: Staff and Audit Logs
--  10. Migration 010: Store Settings and CMS
--
-- ========================================
...
-- RLS POLICIES (using DROP IF EXISTS to avoid duplicate policy errors)
...
DROP POLICY IF EXISTS "Items viewable related to order" ON public.order_items;
...
-- ========================================
-- MIGRATION 008: Payment Processing
-- ========================================
...
-- ========================================
-- MIGRATION 009: Staff and Audit Logs
-- ========================================
...
-- Next step: Run the seed data (see seed.sql)
-- ========================================
